...
WS.sendRequest(findTestObject('JSON API/Get'))

// The below script demonstrates how to verify the response returned from the server.

ResponseObject response = WS.sendRequest(findTestObject('Object Repository/JSON API/Get')) // Get the response object
